...
@Composable
fun rememberScreenScrollState() : ScreenScrollState {
...
class ScreenScrollState(
    ...
    val anchors = mapOf(0f to 1, -swipeAreaHeight to 0)
    ...
    val isHeaderShrinked @Composable get() = swipeableState.currentValue == 1

    fun shrinkHeader() = coroutineScope.launch { swipeableState.animateTo(1) }
    fun expandHeader() = coroutineScope.launch { swipeableState.animateTo(0) }
